...
wk.register({
    ...
    h = { "<cmd> KittyNavigateLeft<cr>", "Move to Split (left)" },
    j = { "<cmd> KittyNavigateDown<cr>", "Move to Split (down)" },
    k = { "<cmd> KittyNavigateUp<cr>", "Move to Split (up)" },
    l = { "<cmd> KittyNavigateRight<cr>" , "Move to Split (right)" },
